      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-lg text-gray-600 max-w-2xl mx-auto">
            We'd love to see you in person! Stop by for a coffee, a chat, or just to enjoy our cozy atmosphere.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="rounded-lg overflow-hidden h-96 shadow-lg">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d193595.15830869428!2d-74.11976397304605!3d40.69766374874431!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew%20York%2C%20NY%2C%20USA!5e0!3m2!1sen!2s!4v1621521555493!5m2!1sen!2s" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
              allowFullScreen 
        ...
        <div className="mt-16 bg-white p-8 rounded-lg shadow-lg">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              <Button className="bg-amber-800 hover:bg-amber-900 w-full md:w-auto">
                Send Message
              </Button>
            </div>
          </form>
