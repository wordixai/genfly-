      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            We'd love to see you! Stop by for a coffee, a bite to eat, or just to say hello.
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Downtown, City 10001</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">hello@brewandbites.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Monday - Friday: 7AM - 8PM</p>
                  <p className="text-gray-700">Saturday - Sunday: 8AM - 9PM</p>
                </div>
              </div>
            </div>
