      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-gray-600">
            We'd love to see you! Stop by for a coffee or reach out to us with any questions.
          </p>
        </div>
          ...
          <div className="bg-gray-100 p-8 rounded-lg">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="bg-amber-800 p-2 rounded-full mr-4 mt-1">
                  <MapPin className="h-5 w-5 text-white" />
                </div>
                <div>
                  <p className="font-medium text-gray-900">Address</p>
                  <p className="text-gray-600">123 Coffee Street</p>
                  <p className="text-gray-600">Brewville, CA 90210</p>
                </div>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-amber-800 p-2 rounded-full text-white hover:bg-amber-900">
