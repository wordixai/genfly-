      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <h3 className="text-2xl font-bold text-amber-500 mb-4">Brew & Bites</h3>
            <p className="text-gray-400 mb-4">
              A cozy corner in the heart of the city where quality coffee meets delicious food.
            </p>
          ...
          <div>
            ...
            <form className="flex">
              <input
                ...
                className="px-4 py-2 w-full rounded-l-md focus:outline-none focus:ring-2 focus:ring-amber-500"
              />
              <button
                type="submit"
                className="bg-amber-600 text-white px-4 py-2 rounded-r-md hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-amber-500"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} Brew & Bites. All rights reserved.
            </p>
