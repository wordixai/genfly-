    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-bold text-amber-500 mb-4">Brew Haven</h3>
            <p className="text-gray-400">
              A cozy spot to enjoy exceptional coffee, delicious food, and good company.
            </p>
          </div>
          ...
          <div>
            ...
            <form className="flex">
              <input 
                ...
                className="px-4 py-2 w-full rounded-l-md focus:outline-none focus:ring-2 focus:ring-amber-500 text-gray-900"
              />
              <button 
                type="submit" 
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">© 2023 Brew Haven. All rights reserved.</p>
